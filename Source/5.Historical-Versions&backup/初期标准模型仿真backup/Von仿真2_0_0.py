...
#Update         开始修改旧版Von生成与判断
#               1.更改生成的Von带宽范围至200-500GHz，对应标准单位16-40
#               2.图中不再显示具体带宽，以标准单位代替
#-----------------------------------------------------------------------#
...
def create_von(physical_net, num_von_nodes, num_von_links, min_bandwidth_unit, min_units, max_units):
    von = nx.Graph()
...
while len(vons) < num_vons:
    von = create_von(physical_network, num_von_nodes=5, num_von_links=7,
